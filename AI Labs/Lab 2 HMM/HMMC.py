...
# Hardcoded HMM parameters based on assignment description
A_matrix = [
    [0.7, 0.05, 0.25],
    [0.1, 0.8, 0.1],
    [0.2, 0.3, 0.5]
...
# Load observation sequences from files
...
# Observation sequences for T = 1000 and T = 10000
sequence_1000 = load_observation_data('hmm_c_N1000.in')
sequence_10000 = load_observation_data('hmm_c_N10000.in')

# Functions used for Baum-Welch algorithm (no changes to these functions)
...
def main():
    # Run the Baum-Welch algorithm for sequence_1000 and sequence_10000
    A_matrix_new_1000, B_matrix_new_1000 = baum_welch(A_matrix, B_matrix, pi, sequence_1000)
    A_matrix_new_10000, B_matrix_new_10000 = baum_welch(A_matrix, B_matrix, pi, sequence_10000)

    # Print the trained matrices
    print("Trained Transition Matrix A for T=1000:")
    print(format_matrix(A_matrix_new_1000))

    print("Trained Emission Matrix B for T=1000:")
    print(format_matrix(B_matrix_new_1000))

    print("Trained Transition Matrix A for T=10000:")
    print(format_matrix(A_matrix_new_10000))

    print("Trained Emission Matrix B for T=10000:")
    print(format_matrix(B_matrix_new_10000))
